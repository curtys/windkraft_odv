...
window.addEventListener('load', function () {
    ...
    // color = d3.scale.ordinal().range(['#0066CC', '#E7423F', '#9817ff', "#24b7f1", "#fa82ce", "#736c31", '#437461',
    //     "#18c199", "#ed990a", "#f2917f", "#7F5680", "#a8b311", '#143367', "#d00d5e", "#1e7b1d", "#05767b", "#aaa1f9",
    //     '#CABFBB', "#a75312", '#830700', "#94b665", "#91529e", "#caa74f", "#c90392", "#a84e5d", "#6a4cf1", "#1ac463"]);

    var color = d3.scale.ordinal().range(["#18c61a", "#9817ff", "#d31911", "#24b7f1", "#fa82ce", "#736c31", "#1263e2",
        "#18c199", "#ed990a", "#f2917f", "#7b637c", "#a8b311", "#a438c0", "#d00d5e", "#1e7b1d", "#05767b", "#aaa1f9",
        "#CABFBB", "#a75312", "#026eb8", "#94b665", "#91529e", "#caa74f", "#c90392", "#a84e5d"]);
